...
class EyeSegmentationConfig(utils.Config):
    ...
    # experiment with resnet50 and resnet101
    BACKBONE = "resnet50"
...
# Use configuation from EyeSegmentationConfig, but override
...
def train_mrcnn(load_last=False):
    """Train Mask R-CNN Model on OpenEDS eye segmentation dataset."""
